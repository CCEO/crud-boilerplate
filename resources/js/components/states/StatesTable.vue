    ...
    <div class="table">
        <v-server-table :options="options" ref="table" :columns="columns" class=" table-borderless"
            ...
            <div slot="beforeTable" class="mb-1 d-inline-block" v-if="headings.length">
                ...
                <button class="btn btn-outline-dark" @click="$modal.show('state-modal', {reset: true})">
                    Nuevo estado
                </button>
            </div>
        ...
        <state-modal @created="reloadTable"></state-modal>
        <v-dialog/>
        <br>
    </div>
</template>
...
<script>
    import StatesTableColumns from "./StatesTableColumns";
                ...
                this.$modal.show("dialog", {
                    ...
                    buttons: [
                        ...
                        },
                        {
                            title: "Eliminar",
                            handler: () => {
                                axios.delete(this.route("states.destroy", id)).then(this.reloadTable);
